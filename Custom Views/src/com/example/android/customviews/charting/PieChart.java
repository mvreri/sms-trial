...
public class PieChart extends ViewGroup {
    ...
    private static final int SHADOW_DELTA = 50;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mShadowBounds = new RectF(
                mPieBounds.left + SHADOW_DELTA,
                mPieBounds.top + SHADOW_DELTA,
                mPieBounds.right + SHADOW_DELTA,
                mPieBounds.bottom + SHADOW_DELTA);
    ...
    private void init() {
        ...
        mShadowPaint.setColor(0xffCDcdCD);
